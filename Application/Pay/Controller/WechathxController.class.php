...
class WechathxController extends PayController
{
    ...
    public function notifyurl()
    {
        ...
        if (file_exists(dirname(__FILE__).'/'.'notifylog/Wechathx.txt')) {
            $log_data = file_get_contents(dirname(__FILE__).'/'.'notifylog/Wechathx.txt');
            $log_data = $log_data. "\r\n" .$testxml. "\r\n";
            file_put_contents(dirname(__FILE__).'/'.'notifylog/Wechathx.txt', $log_data);
        }else{
            file_put_contents(dirname(__FILE__).'/'.'notifylog/Wechathx.txt', $testxml);
        }
        $Order = M("Order");
